						...
						<?php if ( $provider_new_app_link ){ ?>
							<?php if ( $require_client_id ){ // key or id ? ?>
								<tr valign="top" <?php if( ! get_option( 'wsl_settings_' . $provider_id . '_enabled' ) ) echo 'style="display:none"'; ?> class="wsl_tr_settings_<?php echo $provider_id; ?>" >
									...
									<td><input dir="ltr" type="text" name="<?php echo 'wsl_settings_' . $provider_id . '_app_id' ?>" value="<?php echo apply_filters( 'wsl_credentials', get_option( 'wsl_settings_' . $provider_id . '_app_id' ) ); ?>" ></td>
							...
							<?php } else { ?>
								<tr valign="top" <?php if( ! get_option( 'wsl_settings_' . $provider_id . '_enabled' ) ) echo 'style="display:none"'; ?> class="wsl_tr_settings_<?php echo $provider_id; ?>" >
									...
									<td><input dir="ltr" type="text" name="<?php echo 'wsl_settings_' . $provider_id . '_app_key' ?>" value="<?php echo apply_filters( 'wsl_credentials', get_option( 'wsl_settings_' . $provider_id . '_app_key' ) ); ?>" ></td>
									<td><a href="javascript:void(0)" onClick="toggleproviderhelp('<?php echo $provider_id; ?>')"><?php _wsl_e("Where do I get this info?", 'wordpress-social-login') ?></a></td>
								</tr>
							<?php }; ?>
							...
							<?php if( ! $require_api_key ) { ?>
								<tr valign="top" <?php if( ! get_option( 'wsl_settings_' . $provider_id . '_enabled' ) ) echo 'style="display:none"'; ?> class="wsl_tr_settings_<?php echo $provider_id; ?>" >
									...
									<td><input dir="ltr" type="text" name="<?php echo 'wsl_settings_' . $provider_id . '_app_secret' ?>" value="<?php echo apply_filters( 'wsl_credentials', get_option( 'wsl_settings_' . $provider_id . '_app_secret' ) ); ?>" ></td>
									<td><a href="javascript:void(0)" onClick="toggleproviderhelp('<?php echo $provider_id; ?>')"><?php _wsl_e("Where do I get this info?", 'wordpress-social-login') ?></a></td>
								</tr>
							<?php } ?>
					...
					<div style="margin-left:40px;">
						<?php if ( $provider_new_app_link  ) : ?>
							...
							<?php elseif ( $provider_id == "Facebook" ) : ?>
								...
								<p><?php echo "<b>" . ++$setupsteps . "</b>." ?> <?php _wsl_e("Fill out App Domains, Privacy Policy URL, Category, Business Use fields on <b>Facebook Login</b> > <b>Settings</b> > <b>Basic</b>", 'wordpress-social-login') ?>.</p>
								<p><?php echo "<b>" . ++$setupsteps . "</b>." ?> <?php _wsl_e("Make the app public from the top bar On/Off Status toggle", 'wordpress-social-login') ?>.</p>
							<?php else: ?>
							...
							<?php elseif ( $provider_id == "Facebook" ) : ?>
								<p><?php echo "<b>" . ++$setupsteps . "</b>." ?> <?php _wsl_e("Go back to the <b>Settings</b> > <b>Basic</b> page and paste the created application credentials (APP ID and Secret) into the boxes above", 'wordpress-social-login') ?>.</p>
							<?php else: ?>
						...
						<?php if ( $provider_id == "Facebook" ) : ?>
							<table style="text-align: center;margin-bottom:12px;">
								...
								<tr>
									<td><a class="span4 thumbnail" href="<?php echo $assets_setup_base_url . 'facebook/4.png' ?>" target="_blank"><img src="<?php echo $assets_setup_base_url . 'facebook/4.png' ?>"></a></td>
									<td><a class="span4 thumbnail" href="<?php echo $assets_setup_base_url . 'facebook/5.png' ?>" target="_blank"><img src="<?php echo $assets_setup_base_url . 'facebook/5.png' ?>"></a></td>
								</tr>
							</table>
						<?php endif; ?>
